...
export const Navbar = ({
  ...
  const ctaText = primaryCtaText || "Submit a Scenario";
  const homeUrl = primaryCtaLink || "https://rscprivatelending.com";
  const logoAlt = companyName || "RSC Private Lending";
            ...
            <div className="hidden lg:flex flex-shrink-0">
              <Dialog>
                <DialogTrigger asChild>
                  <button className="flex items-center justify-center bg-[#E14141] hover:bg-[#c63434] text-white font-semibold text-base rounded-full transition-all duration-200 hover:translate-y-[-1px] hover:shadow-md whitespace-nowrap border-0 px-8 py-3.5">
                    {ctaText}
                  </button>
                </DialogTrigger>
